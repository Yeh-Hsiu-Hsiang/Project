...
import com.example.weather.activities.GraphActivity;
import com.example.weather.activities.MapActivity;
...
public class Weekweather extends BaseActivity implements LocationListener {
    ...
    private ProgressDialog progressDialog = new ProgressDialog( Weekweather.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog( Weekweather.this);
    ...
    protected void onDestroy() {
        ...
        if (locationManager != null) {
            try {
                locationManager.removeUpdates( Weekweather.this);
    ...
    private void preloadUVIndex() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences( Weekweather.this);
        ...
        if (!lastUVIToday.isEmpty()) {
            ...
            new Weekweather.TodayUVITask(this, this, progressDialog).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "coords", Double.toString(latitude), Double.toString(longitude));
        }
    }
    ...
    private void preloadWeather() {
        ...
        if (!lastToday.isEmpty()) {
            new Weekweather.TodayWeatherTask(this, this, progressDialog).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "cachedResponse", lastToday);
        }
        String lastLongterm = sp.getString("lastLongterm", "");
        if (!lastLongterm.isEmpty()) {
            new Weekweather.LongTermWeatherTask(this, this, progressDialog).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "cachedResponse", lastLongterm);
        }
    }
    ...
    private void getTodayUVIndex() {
        double latitude = todayWeather.getLat();
        double longitude = todayWeather.getLon();
        new Weekweather.TodayUVITask(this, this, progressDialog).execute("coords", Double.toString(latitude), Double.toString(longitude));
    }

    private void getTodayWeather() {
        new Weekweather.TodayWeatherTask(this, this, progressDialog).execute();
    }

    private void getLongTermWeather() {
        new Weekweather.LongTermWeatherTask(this, this, progressDialog).execute();
    }
    ...
    private void searchCities() {
        ...
        alert.setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (!result.isEmpty()) {
                    new Weekweather.FindCitiesByNameTask(getApplicationContext(),
                            Weekweather.this, progressDialog).execute("city", result);
                }
            }
        });
    ...
    private void saveLocation(String result) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences( Weekweather.this);
...
//        }
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences( Weekweather.this).edit();
    ...
    private void updateTodayWeatherUI() {
        ...
        todayIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent( Weekweather.this, GraphActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_map) {
            Intent intent = new Intent( Weekweather.this, MapActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent( Weekweather.this, SettingsActivity.class);
            startActivity(intent);
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        new Weekweather.ProvideCityNameTask(this, this, progressDialog).execute("coords", Double.toString(latitude), Double.toString(longitude));
    }
    ...
    class TodayWeatherTask extends GenericRequestTask {
        public TodayWeatherTask(Context context, Weekweather activity, ProgressDialog progressDialog) {
        ...
        protected void onPostExecute(TaskOutput output) {
            ...
            // Update widgets
            AbstractWidgetProvider.updateWidgets( Weekweather.this);
            DashClockWeatherExtension.updateDashClock( Weekweather.this);
        }
    ...
    class LongTermWeatherTask extends GenericRequestTask {
        public LongTermWeatherTask(Context context, Weekweather activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class FindCitiesByNameTask extends GenericRequestTask {
        ...
        public FindCitiesByNameTask(Context context, Weekweather activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
...
//                saveLocation(reader.getString("id"));
    ...
    class ProvideCityNameTask extends GenericRequestTask {
        ...
        public ProvideCityNameTask(Context context, Weekweather activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class TodayUVITask extends GenericRequestTask {
        public TodayUVITask(Context context, Weekweather activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
